    ...
    ?>
                <table border="0" width="100%">
                    <tr>
                        <td width="300px"></td>
                        <td>
                            <form method="POST" action="../controller/teacher_regCheck.php" enctype="multipart/form-data" onsubmit="return validateTeacher()">
                            ...
                            <tr>
                                <td>Email</td>
                                <td>:
                                    <input type="email" name="email" id="email"> <button title="sample@example.com"><b> i</b></button>
                            ...
                            <tr>
                                <td colspan="2">
                                    <fieldset>
                                     ...
                                     <input type="file" name="profilePicteacher" id="profilePic">
                                    </fieldset>
            ...
            <script src="../js/teacher_regcheck.js"></script>
            <?php 
