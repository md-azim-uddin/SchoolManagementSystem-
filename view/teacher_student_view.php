        ...
        <form action="../controller/teacher_upload_check.php" method="POST" enctype="multipart/form-data">
            <?php 
                if(isset($_COOKIE['class0'])){
                    ...
                    echo '<a href="../view/get_student_details.php?class=math">'.$_COOKIE['subject0'].'</a> | ';
                }
                if(isset($_COOKIE['class1'])){
                                                                
                    echo '<a href="../view/get_student_details.php?class=english"">'.$_COOKIE['subject1'].'</a> | ';
                }
                if(isset($_COOKIE['class2'])){
                                                                
                    echo '<a href="">'.$_COOKIE['subject2'].'</a> | ';
                }
                if(isset($_COOKIE['class3'])){
                                                                
                    echo '<a href="">'.$_COOKIE['subject3'].'</a>  ';
                }
            ?>   
            <br>
