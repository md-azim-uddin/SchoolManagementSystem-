...
function validateStudent() {
    ...
    if (Class == "") {
        document.getElementById('msg8').innerHTML = "*Class field cannot be empty";
        return false;
    }
    let dob = document.getElementById('dob').value;
    let year = dob.split("-")
    if (dob == "") {
        document.getElementById('msg9').innerHTML = "**Date of Birth cannot be empty";
        return false;
    } else {
        if (year[0] > 2016) {
            document.getElementById('msg9').innerHTML = "**year must be more than 2016";
        }
    }
    let profilePic = document.getElementById('profilePic').value;
    if (profilePic == "") {
        document.getElementById('msg10').innerHTML = "**Profile Picture cannot be empty";
        return false;
    }
